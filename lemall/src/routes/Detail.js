...
class Detail extends React.Component {
    constructor() {
        ...
        this.state = {
            ...
            evaluate:[{name:"鑫龙哥",star:"http://img1-lemall.letvimg.com/wap/20150703/default/1269149961952114",dec:"唯一遗憾的就是居然不配语音功能的遥控器，后来自己又买了一个语音功能的遥控器。",time:"2018-06-05 21:12:41"},{name:"快乐观点2446",star:"http://img1-lemall.letvimg.com/wap/20150703/default/1269149761687662",dec:"安裝費居然收了179，掛羊頭賣狗肉，有名無實；含七啊！",time:"2018-05-04 10:41:04"},{name:"北京乐迷",star:'http://img1-lemall.letvimg.com/wap/20150703/default/1269150025591070',dec:"已收到货，增值税开票相关信息已发至你们的邮箱，请查阅！",time:"2018-05-02 15:59:13"}],
    ...
    render() {
        let {name, bigpic, dec, price} = result[0],
            size = /(\d)+/g.exec(name)[0];
        ...
        return <div className="detailBox">
                        ...
                        this.state.memberDiscount.map((item,index)=>{
                            return <li key={index}>
                                ...
                                <div className="memberRadio">
                                    <input type="radio" id={`check${index}`} name="member" onClick={this.checked.bind(this,index)}/>
                    ...
                    this.state.evaluate.map((item,index)=>{
                        return <div className="evaluateDetail" key={index}>
                            <div className="person">
                                <div className="icon">
                                    <img src="http://img1-lemall.letvimg.com/wap/20150701/default/1094985529810084" alt=""/>
                                </div>
                                <div className="name">
                                    <span>{item.name}</span>
                                </div>
            ...
            {/*加入购物车*/}
            <div className="add">
                <div className="shoppingCartIcon"><Link to={"/shopCart"}><Icon type="shopping-cart"></Icon><p>0ddasda</p></Link></div>
    ...
    checked=(index)=>{
        this.setState({
            detail:{content:this.state.memberDiscount[index]["time"],price:this.state.memberDiscount[index]["price"]}
        })
    }
    addCart=()=>{
        ...
        this.props.add(obj);
        this.alertBox.className+=" alertBox";
        let timer=setInterval(()=>{
            this.alertBox.classList=["alertUnshow"]
        },3000)
    }
